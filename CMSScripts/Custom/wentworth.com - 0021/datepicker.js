...
function avSubmit(){
	if ( document.getElementById("hotelCode")) { 
		if (document.getElementById("hotelCode").selectedIndex==0 && document.getElementById("hotelCode").length>1) { 
	...
	try {
		if ( document.getElementById('requestType').selectedIndex > 0 && document.getElementById('requestType').selectedIndex < 4 && ( document.getElementById('codebox').value=='' || document.getElementById('codebox').value=='Enter Code' ) ) {
			alert('You have selected a sepcial Rate but not provided any codes.');
			void(0);
			return;
		}
	} catch (error) {}
	document.getElementById("tbtAv").style.visibility="hidden";
	document.getElementById("avwaitmsgAv").style.visibility="visible";

jQuery(function() {
    jQuery('.availabityFormDiv button').click(function(e) {
      ...
      if (hc=="") {  // if no properties Selected
          ...
          var bookingLink = "https://www.marriott.com/reservation/availability.mi?propertyCode=PSMWW&PTNR=ocean_mthkl&fromDate=" + checkIn + "&toDate=" + checkOut + "&numberOfRooms=" + rooms + "&numberOfGuests=" + guests + promo;

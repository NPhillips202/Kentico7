jQuery(document).ready(function() {
  ...
  jQuery('#expand, #expand2, #expand3, #expand4, #expand5').find('li:gt(0)').addClass('toggletr').hide()
.end().append(
...
jQuery(function(jQuery) {
	...
	function initializeMobileMenu() {
      ...
      ul.prepend('<li><a href="https://m.ihotelier.com/96879/booking.html?hotelid=96879">Reservations1</a></li>');
 ...
 // console.log(jQuery('#cboxOverlay').length);
  ...
  jQuery(document).ready(function() {
    ...
    // http://www.cendynone.com/home-updated-slider/?mock=true
    jQuery(document).ready(function() {
    jQuery.simpleWeather({
    location: 'St Thomas, US Virgin Islands',
    woeid: '',

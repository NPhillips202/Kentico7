jQuery(function() {
	...
	bookingSubmitBtn.click(function(e) {
        ...
        if (promoTypeVal !== '' && promoVal !== 'Promo Code') {
          ...
          console.log("This is " + promoQuery);
        };
  
		 console.log("This is " + promoQuery);
		//var bookingUrl = bookingLink + "?startDate=" + checkInDate + "&endDate=" + checkOutDate + "&adults=" + adultsVal + "&children=" + childrenVal + "&requestType=" + promoTypeVal + "&code=" + promoValpromoQuery;

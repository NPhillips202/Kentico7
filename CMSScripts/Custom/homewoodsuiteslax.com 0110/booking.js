  ...
  // Set default dates
    ...
    jQuery('.bookingMask .button').click(function(e) {
       ...
       // var rooms = thisForm.find('select#rooms').val();
        ...
        var bookingUrl = 'https://secure3.hilton.com/en_US/hi/reservation/book.htm?ctyhocn=LAXSWHW&arrivalDay=' + arrivalDay + '&arrivalMonth=' + arrivalMonth + '&arrivalYear=' + arrivalYear + '&departureDay=' + departureDay + '&departureMonth=' + departureMonth + '&departureYear=' + departureYear + '&numAdults=' + adults;

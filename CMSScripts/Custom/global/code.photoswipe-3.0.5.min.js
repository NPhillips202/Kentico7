...
// Chrome mobile fix
function handleTouch(e){if(console.log("handle touch"),e.target==redblock)switch(e.preventDefault(),e.type){case"touchstart":console.log("touchstart"),touchOriginY=e.targetTouches[0].screenY;break;case"touchmove":console.log("touchmove"),redblock.innerHTML=e.targetTouches[0].screenY;var t=e.targetTouches[0].screenY-touchOriginY;console.log(" "+t),redblock.style[TRANSFORM]="translate3d(0,"+t+"px,0)";break;case"touchcancel":console.log("touchcancel");case"touchend":console.log("touchend"),console.log("snap return"),redblock.style[TRANSFORM]="translate3d(0,0,0)"}}var TRANSITION_END="webkitTransitionEnd",TRANSITION_CSS="-webkit-transition",TRANSFORM_CSS="-webkit-transform",TRANSFORM="webkitTransform",TRANSITION="webkitTransition";document.body.style.transform&&(TRANSITION_END="transitionend",TRANSITION_CSS="transition",TRANSFORM_CSS="transform",TRANSFORM="transform",TRANSITION="transition");var $=function(e){return document.querySelector(e)},el=document.body,redblock=$(".splash-section"),touchOriginY,windowTop=0,windowBottom=document.height;el.addEventListener("touchstart",handleTouch),el.addEventListener("touchend",handleTouch),el.addEventListener("touchmove",handleTouch),el.addEventListener(TRANSITION_END,function(){});
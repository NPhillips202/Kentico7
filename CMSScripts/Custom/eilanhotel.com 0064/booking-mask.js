jQuery(function() {
  ...
  myCheckOutField.attr('value', todayPlus2);
    ...
    buttonImage: "/getmedia/ff7ed19b-2448-4f4f-8e69-23d3c9042000/cal-icon",
  ...
  bookingSubmitBtn.click(function(e) {
    ...
    var bookingUrl = booking.find('> a').attr('href') + '&fromDate=' + check_in + '&toDate=' + check_out + '&numberOfRooms=' + rooms + '&numberOfGuests=' + guests;

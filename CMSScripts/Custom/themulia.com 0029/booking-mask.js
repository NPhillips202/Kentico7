...
jQuery(function() {
	...
	*/
	...
	bookingSubmitBtn.click(function(e) {
		...
		var bookingUrl = 'http://gc.synxis.com/rez.aspx?Hotel=' + (hotel ? hotel : '') + '&Chain=' + chain + '&rooms=' + rooms + '&arrive=' + arrive + '&depart=' + depart + '&adult=' + adult + '&child=' + children + rate + start + '&locale=' + locale + '&Dest=' + dest + no_hotel + '&template=RBE&shell=RBE';

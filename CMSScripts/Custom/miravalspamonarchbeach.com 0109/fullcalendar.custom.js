...
function addCustomJSONEventItems(items, customItems) {
	...
	if(customItems.length) {
		...
		items.forEach(function(item) {
			//debugger;
			//console.log(typeof customItems[i]);
...
function loadFullCalendar(allEvents) {
	...
	options = {
		...
		header: {
			...
			center: 'title',
			right: 'list,basicDay', // 'list,month' //'list,agendaList,month'//'listYear,month' //'list,weekList,month' // 'agendaOne,weekList,month'
		},
	...
	*/
	...
	//
	//calendar_div.fullCalendar('changeView', 'agendaDay');
	calendar_div.fullCalendar('changeView', 'basicDay');

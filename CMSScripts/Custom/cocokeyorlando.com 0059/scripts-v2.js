// scripts.js (Renaissance Pittsburgh)
/**
...
var win = jQuery(window),
  ...
  minorAdditions = function() {   
    ...
    //
    jQuery('#footer div.navbar-two ul').append('<li><a href="#" class="sitemap-toggle">SiteMap</a></li>');
  },
  ...
  megaMenuAdjustment = function() {
    jQuery('#menu ul ul').each(function(index) {
      ...
      if(li_len > 5 ) {
        ...
        var splitIndex = Math.ceil(li_len / 2);
...
jQuery(function() {
  ...
  */
  ...
  // purchase-day-pass
  var purchaseDayPass = jQuery('.purchase-day-pass');
  /*win.resize(function(){
      purchaseDayPass.magnificPopup({
          type: 'iframe',
          iframe: {
              markup: '<div class="mfp-iframe-scaler">'+
                  '<div class="mfp-close"></div>'+
          ...
          //}
      //});
      //var dayPassMagnificPopup = purchaseDayPass.magnificPopup.instance; // save instance in magnificPopup variable
      //console.log(dayPassMagnificPopup);
      if(viewport() < 608) {
          // do not attach magnific popup
      } else {
  ...
  // ...then load font and other jQuery functions
   ...
   jQuery('.booking-engine-special').click(function() {
      window.open('https://res.windsurfercrs.com/ibe/details.aspx?propertyid=14384&rate=PROQ117&nono=1&CheckIn=01/02/2017', '_blank');
   });
});

  ...
  */
  ...
  var fliptoSettings = {
      ...
      (function () {
          ...
          if (fliptoSettings.code !== '' || (fn('flipto') !== '' && fliptoSettings.isAllowUrlCode)) {
              var ft = document.createElement('script'); ft.type = 'text/javascript';
              ft.src = '//flip.to/external/signup.js?&c=' + fliptoSettings.code + '&revcode=' + fliptoSettings.reviewCampaign + '&lang=' + fliptoSettings.language + '&loc=' + fliptoSettings.parent + '&pt=' + fliptoSettings.pageType + fn('debug') + fn('trk') + (fliptoSettings.isAllowUrlCode?fn('flipto'):'');

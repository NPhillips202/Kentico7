jQuery(function() {
  ...
  var myCheckInField = jQuery('input[name="check-in"]'),
    ...
    myChildrenCount = jQuery('#rooms').find('option:selected').text(),
    myGuestsCount = jQuery('#guests').find('option:selected').text(),
    booking = jQuery('#booking-engine'),
    //booking = jQuery('#main-nav').children('#booking-engine'),
    bookingLink = booking.children('a').attr('href'),
  ...
  myCheckOutField.attr('value', todayPlus2);
    ...
    buttonImage: "/getmedia/00aaf1ef-32ae-483c-8b9b-331d811d2eb5/cal-icon",
  ...
  bookingSubmitBtn.click(function(e) {
   ...
   // -- EDIT THIS BOOKING URL FOR DIFFERENT TYPES OF BOOKING MASKS		
		var bookingUrl = bookingLink + 
                         '&checkin=' + check_in +
                         '&checkout=' + check_out +
                         '&children=' + myChildrenCount +

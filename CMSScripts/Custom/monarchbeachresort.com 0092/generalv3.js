...
jQuery(document).ready(function () {
	...
	console.log('jQuery(.swiper-container).length: ',jQuery('.swiper-container').length);
	console.log('jQuery(.swiper-container-2).length: ',jQuery('.swiper-container-2').length);
	console.log('jQuery(.swiper-room).length: ',jQuery('.swiper-room').length);
	console.log('jQuery(.swiper-container-home).length: ',jQuery('.swiper-container-home').length);
	...
	if(jQuery('.swiper-container-home').length) {
		...
		pagination: '.swiper-container-home',
		effect: 'fade',
		loop: true,
		paginationClickable: true,
		preloadImages: false // Disable preloading of all images

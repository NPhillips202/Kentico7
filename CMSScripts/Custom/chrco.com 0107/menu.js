        ...
        return this.each(function (i) {
            ...
            if ('ontouchstart' in window) {
                ...
                menuobj.find("a").click(function (e) {
                    if (!$(this).hasClass("link") && !$("body").hasClass("mob") && jQuery(this).next().length > 0) {
                        e.preventDefault();
                        if (jQuery(this).hasClass("firstLevel")) {
                            menuobj.find("a").removeClass("link");
                            menuobj.find("a").parent().removeClass("hover");
                        }
                        if (jQuery(this).next(".nav-sub-section").length) {
                            jQuery(this).next(".sb-menu").find("li").eq(0).addClass("hover");
                            jQuery(this).next(".sb-menu").find("li").eq(0).children("a").addClass("link");
                        }
                        jQuery(this).closest("li").siblings().removeClass('hover');
                        jQuery(this).closest("li").siblings().children("a").removeClass("link");
                ...
                menuobj.find("li").mouseenter(function () {
                    ...
                    if (jQuery(this).children(".nav-sub-section").length) {
                        jQuery(this).children(".sb-menu").find("li").eq(0).addClass("hover");
                    }

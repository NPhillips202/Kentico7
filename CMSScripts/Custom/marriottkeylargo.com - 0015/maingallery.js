 ...
 jQuery('.gallery-main').append("</ul></div>");
     ...
     jQuery("ul li a").filter(function() {
        if(jQuery(this).text() == "Meeting Offers"){ 
            ...
            jQuery(this).attr("href", "/key-largo-meeting-offers/");
          }
     }).length;
  ...
  jQuery("ul li a").filter(function() {
        if(jQuery(this).text() == "Wedding Offers"){ 
            ...
            jQuery(this).attr("href", "/key-largo-wedding-offers/");
          }
     }).length;
  ...
  jQuery("ul li a").filter(function() {
        if(jQuery(this).text() == "Spa Offers"){ 
            ...
            jQuery(this).attr("href", "/key-largo-spa-offers/");
          }
     }).length;
  ...
  jQuery("ul li a").filter(function() {
        if(jQuery(this).text() == "Dining Offers"){ 
            ...
            jQuery(this).attr("href", "/key-largo-dining-offers/");
          }
     }).length;

...
/*
====================================================================================================
@name			Courtyard Marriott Austin - custom.js
@version		1.0.0
@author			Les Fleurimond / Cendyn/ONE
@author-uri		http://cendynone.com
@copyright		2015 Les Fleurimond / Cendyn/ONE
====================================================================================================
*/
...
var bookingWidgetModal = function() {
	...
	book_now_link.click(function(e){
		if ( viewport() <= 765 ) {
			//var bookingUrl = 'http://www.marriott.com/auscy';
			//jQuery('#book-now-link').attr('href',bookingUrl);
		} else { 
			e.preventDefault();
		};
...
var slickSlider = function() {
	...
	stay_with_us_section.find('.slick.slick-nav').slick({
		...
		onInit: function(slick) {
			...
			//slick_slide.removeClass('slick-current slick-active');
		...
		onAfterChange: function(slick, index) {
			...
			//console.log(index);
			//console.log(slick_slide_length);

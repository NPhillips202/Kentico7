...
/////////////////
 ...
 jQuery(function() {
    ...
    e.click(function(a) {
       ...
       // Set default dates top drop down booking
      //jQuery(".make_a_reservation .make_a_reservation_form .forma-area #bookingMask #check-in #datepicker1").datepicker('setDate', new Date());
      //var date3 = jQuery('.make_a_reservation .make_a_reservation_form .forma-area #bookingMask #check-in #datepicker1').datepicker('getDate', '+2d');
      //date3.setDate(date3.getDate()+2);
      //jQuery('.make_a_reservation .make_a_reservation_form .forma-area #bookingMask #check-out #datepicker2').datepicker('setDate', date3);
   
       // Set default dates on slider booking
      jQuery("#check-in #datepicker1").datepicker('setDate', new Date());
      var date4 = jQuery('.book-banner .main .form-book .formbook-contain .forma-area #bookingMask #check-in #datepicker1').datepicker('getDate', '+2d');
      date4.setDate(date4.getDate()+2);
      jQuery('#check-out #datepicker2').datepicker('setDate', date4);

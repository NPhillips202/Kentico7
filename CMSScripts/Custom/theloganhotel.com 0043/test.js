...
//bxSlider moved inline on home page
...
//Top navigation sticky header
   var wrap = jQuery(window); 
    wrap.on('scroll', function(e) {
        if (jQuery('body').scrollTop() > 40) {         
            jQuery('#wrap').addClass('fix-topNavigation');
            jQuery('#wrap').addClass('fix-topMenu');
            jQuery('.tab-type01').find('h2').removeClass('active');
            jQuery(".inside-content02").slideUp('');
        } else {
            jQuery('#wrap').removeClass('fix-topNavigation');
            jQuery('#wrap').removeClass('fix-topMenu');
            jQuery('.tab-type01').find('h2').addClass('active');
            jQuery(".inside-content02").slideDown();
        }
    });
    //# sourceURL=pen.js
...
// css_browser_selector.js STARTS

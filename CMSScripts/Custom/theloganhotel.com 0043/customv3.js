...
//-- Site Map Position
  //jQuery('footer #footerWrapper #footerBottom .footer-nav ul').append('<li><a href="#" class="sitemap-toggle">Site Map</a></li>');
...
//Jquery, Remove class when width screen is 767px	
  function checkWidth() {

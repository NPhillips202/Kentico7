...

 {
    ...
    var data = [ // The Logan Hotel
      { //The Logan Hotel
        ...
        'icon': 'https://www.theloganhotel.com/Theloganhotel.com-0043-2015Redesign/media/theloganhotel.com-0043/graphics/marker-hotel.png',
        'iconActive': 'https://www.theloganhotel.com/Theloganhotel.com-0043-2015Redesign/media/theloganhotel.com-0043/graphics/marker-hotel-current.png'
      },
      { //Franklin Institute
        'id':1,
        ...
        'position': {
         ...
         'iconActive': 'https://www.theloganhotel.com/Theloganhotel.com-0043-2015Redesign/media/theloganhotel.com-0043/graphics/marker-current.png'
      },
        ...
        google.maps.event.addListener(marker, 'click', (function (marker, i) {
            return function () {
                for (var j = 0; j < markers.length; j++) {
                    markers[j].setIcon(markers[j].defaultIcon);
                }

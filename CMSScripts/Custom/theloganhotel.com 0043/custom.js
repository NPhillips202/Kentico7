...
// --  Mobile Menu Initialization
   ...
   // jQuery('.slicknav_nav').prepend('<li><a href="/special-offers/" role="menuitem" tabindex="0">Special Offers</a></li>');
    //jQuery('.slicknav_nav').prepend('<li><a href="https://secure3.hilton.com/en_US/qq/reservation/book.htm?ctyhocn=PHLQQQQ" role="menuitem" tabindex="0" target="_blank">Reservations</a></li>');
    jQuery('.slicknav_nav').append('<li><a href="/photo-gallery/" role="menuitem" tabindex="0">Photo Gallery</a></li>');
	jQuery('.slicknav_nav').append('<li><a href="/contact-us/" role="menuitem" tabindex="0">Contact Us</a></li>');
    jQuery('.slicknav_menu').prepend('<a href="tel:2159639506"><i class="fa fa-phone"></i></a>');
	jQuery('.slicknav_menu').prepend('<a href="/"><div class="mobile-logo"><img src="/getmedia/a7bb6013-3c88-4cfd-9487-b7ee7d93d827/logan-hotel-logo" /></div></a>');
...
//jQuery NailThumb  
   jQuery('.specialImage').nailthumb({width:190,height:127});

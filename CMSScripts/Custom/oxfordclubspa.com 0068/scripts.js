...
var win = jQuery(window),
  ...
  minorAdditions = function() {   
    ...
    //
    //jQuery('#footer div.info .menuElem:first-child ul').append('<li><a href="#" class="sitemap-toggle">Site Map</a></li>');
    jQuery('#footer #cendyn-info ul').append('<li><a href="#" class="sitemap-toggle">Site Map</a></li>');
  },
...
jQuery(document).ready(function() {
        jQuery('.tab-type01').find('h2').click(function(){ 
            ...
            jQuery(".inside-content02").not($(this).next()).prev().removeClass('active'); 
        });
    });

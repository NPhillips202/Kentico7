jQuery(function() {
 ...
 checkOutDesktop_full.datepicker({
  ...
  bookingSubmitBtn.click(function(e) {
    ...
    //group code
    var groupCode = thisForm.find('input.groupCode').val();
    ...
    if (adults == 'ADULTS') {
      ...
      //updated booking mask 8/31/16..sd
        var bookingUrl = bookingLink + "&start=availresults&arrive=" + checkInDate + "&depart=" + checkOutDate + "&adult=" + adults + "&guest=0" + "&rooms=1" + promoCode + groupCode;

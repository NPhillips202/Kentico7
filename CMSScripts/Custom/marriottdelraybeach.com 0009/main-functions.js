jQuery(document).ready(function() {
    jQuery('.sub-header .img img').each(function() {
...
jQuery(function(){
	...
	jQuery(".iframe").colorbox({
		iframe:true, innerWidth:534, innerHeight:356, width:540, height:383, fixed:true});
});
...
jQuery('.sitemap-content ul li a').each(function(e) {
      if (jQuery(this).text() == 'Miscellaneous') {

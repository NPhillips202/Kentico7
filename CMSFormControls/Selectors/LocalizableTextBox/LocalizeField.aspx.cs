        ...
        if (CMSContext.CurrentUser.IsAuthorizedPerResource("CMS.Localization", "LocalizeStrings"))
        {
            ...
            if (lstExistingOrNew.SelectedIndex == 0)
            {
                ...
                if (ri == null)
                {
                    ...
                    else
                    {
                        ...
                        ScriptHelper.RegisterStartupScript(this, typeof(string), "localizeField", ScriptHelper.GetScript("wopener.SetResourceAndOpen('" + hdnValue + "', '" + key + "', '" + textbox + "', " + ScriptHelper.GetString(plainText) + ", '" + btnLocalizeField + "', '" + btnLocalizeString + "', '" + btnRemoveLocalization + "'); CloseDialog();"));
                    }
                }
            ...
            else
            {
                ...
                if (ri == null)
                {
                    ...
                    if (resourceManager != null)
                    {
                        ...
                        if (!String.IsNullOrEmpty(translation))
                        {
                            ...
                            ScriptHelper.RegisterStartupScript(this, typeof(string), "localizeField", ScriptHelper.GetScript("wopener.SetResource('" + hdnValue + "', '" + key + "', '" + textbox + "', " + ScriptHelper.GetString(translation) + ", '" + btnLocalizeField + "', '" + btnLocalizeString + "', '" + btnRemoveLocalization + "'); CloseDialog();"));
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    ScriptHelper.RegisterStartupScript(this, typeof(string), "localizeField", ScriptHelper.GetScript("wopener.SetResource('" + hdnValue + "', '" + key + "', '" + textbox + "', " + ScriptHelper.GetString(existingTranslation) + ", '" + btnLocalizeField + "', '" + btnLocalizeString + "', '" + btnRemoveLocalization + "'); CloseDialog();"));
                }
            }
        }
        else

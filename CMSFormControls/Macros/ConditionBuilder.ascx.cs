...
public partial class CMSFormControls_Macros_ConditionBuilder : FormEngineUserControl
{
    ...
    public override object FormControlParameter
    {
        get
        {
            return GetValue("FormControlParameter");
        }
        set
        {
            SetValue("FormControlParameter", value);
        }
    }
...
function InsertMacroCondition" + this.ClientID + @"(text) {
    ...
    protected void btnEdit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string dialogUrl = String.Format("{0}?clientid={1}&module={2}&ruletype={3}&showactivityrules={4}", CMSContext.ResolveDialogUrl("~/CMSFormControls/Macros/ConditionBuilder.aspx"), ClientID, RuleCategoryNames, DisplayRuleType, String.Equals(FormControlParameter, "showactivityrules"));

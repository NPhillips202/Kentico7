    ...
    protected void SetImage()
    {
        ...
        if (DisplayPicture)
        {
                ...
                if (ui != null)
                {
                    switch (UserAvatarType)
                    {
                        ...
                        case AvatarInfoProvider.GRAVATAR:
                            ...
                            imageUrl = AvatarInfoProvider.CreateGravatarLink(ui.Email, ui.UserSettings.UserGender, null, sideSize, CMSContext.CurrentSiteName);
                            isGravatar = true;
                            Visible = true;
                            AvatarID = 0;
                            break;
            ...
            else
            {
                ...
                {
                    int sideSize = mWidth > 0 ? mWidth : SettingsKeyProvider.GetIntValue(CMSContext.CurrentSiteName + ".CMSAvatarMaxSideSize");
                    imageUrl = AvatarInfoProvider.CreateGravatarLink(UserEmail, (int)UserGenderEnum.Unknown, null, sideSize, CMSContext.CurrentSiteName);
                    isGravatar = true;
                    Visible = true;
                    AvatarID = 0;

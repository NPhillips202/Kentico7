...
public partial class CMSAdminControls_UI_UniGrid_UniGrid : UniGrid, IUniPageable
{
    ...
    private void LoadColumnDefinition(Column column, Table filterTable)
    {
            ...
            (column.MaxLength > 0))
        {
            ...
            if (column.Icon != null)
            {
                if (linkColumn.DataField == String.Empty)
                {
        ...
        if (cssClass != null)
        {
            field.HeaderStyle.CssClass = String.Format("{0} {1}", field.HeaderStyle.CssClass, cssClass).Trim();
            field.ItemStyle.CssClass = String.Format("{0} {1}", field.ItemStyle.CssClass, cssClass).Trim();
            field.FooterStyle.CssClass = String.Format("{0} {1}", field.FooterStyle.CssClass, cssClass).Trim();
        }

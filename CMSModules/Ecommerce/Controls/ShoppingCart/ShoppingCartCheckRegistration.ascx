            ...
            <tr>
                <td>
                    <table id="tblRegistration">
                        ...
                        <tr>
                            <td colspan="3">
                                <p class="explainPass explainPassCheckout">Your password requires 10 characters using upper case letters, lower case letters, numbers, and at least one special character such as !, @, #, $, %, ^, &, or *.</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <tr>
                    <td>
                        <table id="tblAnonymous">
                            ...
                            <tr>
                            <td>
                                <asp:Label ID="lblCaptcha2" runat="server" AssociatedControlID="scCaptcha" EnableViewState="false" />
                                Captcha Verification:
                            </td>
                            <td>
                                <cms:SecurityCode ID="scCaptcha2" GenerateNumberEveryTime="false" runat="server" />
                            </td>
                        </tr>
                        </table>
                    </td>

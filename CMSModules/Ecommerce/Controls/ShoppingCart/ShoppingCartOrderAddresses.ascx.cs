...
public partial class CMSModules_Ecommerce_Controls_ShoppingCart_ShoppingCartOrderAddresses : ShoppingCartStep
{
    ...
    protected void LoadBillingAddressInfo()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                txtBillingName.Text = GetDefaultAddressName(ShoppingCart.Customer);
            }
        }
    }
        ...
        if (plhShipping.Visible)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    // Prefill customer company name or full name
                    txtShippingName.Text = GetDefaultAddressName(ShoppingCart.Customer);
                }
            }
        }
    }
        ...
        if (plcCompanyDetail.Visible)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    // Prefill customer company name or full name
                    txtCompanyName.Text = GetDefaultAddressName(ShoppingCart.Customer);
                }
            }
        }
    }
    ...
    public override bool IsValid()
    {
        ...
        string result = val.NotEmpty(txtBillingName.Text.Trim(), GetString("ShoppingCartOrderAddresses.BillingNameErr"))
            ...
            .NotEmpty(txtBillingZip.Text.Trim(), GetString("ShoppingCartOrderAddresses.BillingZIPErr"))
            .NotEmpty(txtBillingPhone.Text.Trim(), GetString("Please enter a phone number.")).Result;
        ...
        if (result == "")
        {
            ...
            if (chkShippingAddr.Checked)
            {
                ...
                result = val.NotEmpty(txtShippingName.Text.Trim(), GetString("ShoppingCartOrderAddresses.ShippingNameErr"))
                    ...
                    .NotEmpty(txtShippingZip.Text.Trim(), GetString("ShoppingCartOrderAddresses.ShippingZIPErr"))
                    .NotEmpty(txtBillingPhone.Text.Trim(), GetString("Please enter a phone number.")).Result;
            }
            ...
            if ((result == "") && (chkCompanyAddress.Checked))
            {
                ...
                result = val.NotEmpty(txtCompanyName.Text.Trim(), GetString("ShoppingCartOrderAddresses.CompanyNameErr"))
                    ...
                    .NotEmpty(txtCompanyZip.Text.Trim(), GetString("ShoppingCartOrderAddresses.CompanyZIPErr"))
                    .NotEmpty(txtBillingPhone.Text.Trim(), GetString("Please enter a phone number.")).Result;
            }
        }
    ...
    private string GetDefaultAddressName(CustomerInfo customer)
    {
        if (customer == null)
        {
            return string.Empty;
        ...
        {
            return customer.CustomerCompany;
        }

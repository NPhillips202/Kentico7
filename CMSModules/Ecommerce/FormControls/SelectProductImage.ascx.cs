...
public partial class CMSModules_Ecommerce_FormControls_SelectProductImage : FormEngineUserControl
{
    ...
    private string MetaFilePath
    {
        ...
        {
            string path = null;
            DataSet metaFiles = MetaFileInfoProvider.GetMetaFiles(SKUID, SKUObjectType, MetaFileInfoProvider.OBJECT_CATEGORY_IMAGE, null, null);
    ...
    private void TryInitByForm()
    {
        ...
        {
            SKUObjectType = ValidationHelper.GetString(Form.AdditionalData["SKUObjectType"], ECommerceObjectType.SKU);
        }
    }

...
public partial class CMSModules_SmartSearch_Controls_UI_SearchIndex_Forum_Edit : CMSAdminEditControl, IPostBackEventHandler
{
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        selSite.UniSelector.ReturnColumnName = "SiteName";
        selSite.AllowEmpty = false;
        ...
        if (!DataHelper.DataSourceIsEmpty(ds))
        {
            ...
            if (!RequestHelper.IsPostBack() && isNew && siteWhere.Contains("," + CMSContext.CurrentSiteID + ","))
            {
    ...
    protected void SetControlsStatus()
    {
        ...
        if (String.IsNullOrEmpty(siteName) || (siteName == "-1") || (siteName == "##ALL##"))
        {
            selForum.Enabled = false;
        }
        else

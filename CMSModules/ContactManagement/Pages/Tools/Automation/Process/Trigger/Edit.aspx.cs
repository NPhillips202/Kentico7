    ...
    private void SetResolverName()
    {
        switch (SelectedObjectType)
        {
            case PredefinedObjectType.ACTIVITY:
                ...
                // Use custom parameter to decide whether to show activity rules in condition builder or not. By default it's hidden.
                tMacroCondition.EditingControl.FormControlParameter = "showactivityrules";
                break;

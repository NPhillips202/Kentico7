...
public partial class CMSModules_ContactManagement_FormControls_DataComLogin : FormEngineUserControl
{
    #region "Variables"
    ...
    private void ShowInfo()
    {
        ...
        else
        {
            ...
            ShowWarning(GetString("datacom.automation.stepisusinginvalidcredentials"), null, null);
            DisableSaveAction();
        }
    ...
    protected void HeaderActions_ActionPerformed(object sender, CommandEventArgs e)
    {
        switch (e.CommandName.ToLowerInvariant())
        {
            ...
            case "save":
                ...
                ComponentEvents.RequestEvents.RaiseComponentEvent(this, e, ComponentName, ComponentEvents.SAVE);

...
public partial class CMSModules_PortalEngine_Controls_WebParts_WebpartProperties : CMSUserControl
{
    ...
    private void AddExportLink()
    {
        if (webPartInstance != null)
        {
            ltlExport.Text = "&nbsp;<a target=\"_parent\" href=\"GetWebPartProperties.aspx?webpartid=" + webPartInstance.ControlID + "&webpartguid=" + webPartInstance.InstanceGUID + "&aliaspath=" + AliasPath + "&zoneid=" + ZoneId + "&templateid=" + PageTemplateId + "\">" + GetString("WebpartProperties.Export") + "</a>";
        }
    }

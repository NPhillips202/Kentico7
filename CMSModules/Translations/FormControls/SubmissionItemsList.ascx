    ...
    <ContentTemplate>
        <cms:UniGrid runat="server" ID="gridElem" ObjectType="cms.translationsubmissionitem"
            ...
            <GridActions Parameters="SubmissionItemID">
                <ug:Action ExternalSourceName="downloadxliff" Name="downloadxliff" Caption="$translationservice.downloadxliff$"
                    Icon="View.png" />
        ...
        <br />
        <cms:LocalizedButton runat="server" ID="btnExportToZip" ResourceString="translationservice.downloadxliffinzip"
            CssClass="LongButton" />
        <cms:LocalizedButton runat="server" ID="btnImportFromZip" ResourceString="translationservice.importxlifffromzip"
            CssClass="LongButton" />
    </ContentTemplate>
</cms:CMSUpdatePanel>

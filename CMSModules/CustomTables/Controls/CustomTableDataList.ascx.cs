...
public partial class CMSModules_CustomTables_Controls_CustomTableDataList : CMSUserControl
{
    ...
    /// <summary>
    /// Determines whether custom table has IssueDate field.
    /// </summary>
    public bool HasIssueDateField
    {
        get
        {
            if (FormInfo != null)
            {
                return (FormInfo.FieldExists("IssueDate"));
            }
            else
            {
                return false;
    ...
    /// <summary>
    /// Determines whether custom table has IssueYear field.
    /// </summary>
    public bool HasIssueYearField
    {
        get
        {
            if (FormInfo != null)
            {
                return (FormInfo.FieldExists("IssueYear"));
            }
            else
            {
                return false;
    ...
    /// <summary>
    /// Determines whether custom table has PublishDate field.
    /// </summary>
    public bool HasPublishDateField
    {
        get
        {
            if (FormInfo != null)
            {
                return (FormInfo.FieldExists("PublishDate"));
            }
            else
            {
                return false;
    ...
    /// <summary>
    /// Determines whether custom table has StartDate field.
    /// </summary>
    public bool HasStartDateField
    {
        get
        {
            if (FormInfo != null)
            {
                return (FormInfo.FieldExists("StartDate"));
            }
            else
            {
                return false;
    ...
    /// <summary>
    /// Determines whether custom table has DateSubmitted field.
    /// </summary>
    public bool HasDateSubmittedField
    {
        get
        {
            if (FormInfo != null)
            {
                return (FormInfo.FieldExists("DateSubmitted"));
            }
            else
            {
                return false;
    ...
    /// <summary>
    /// Determines whether custom table has ComName field.
    /// </summary>
    public bool HasComNameField
    {
        get
        {
            if (FormInfo != null)
            {
                return (FormInfo.FieldExists("ComName"));
            }
            else
            {
                return false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (HasPublishDateField)
        {
            gridData.OrderBy = "PublishDate DESC";
        }
        else if (HasIssueYearField)
        {
            gridData.OrderBy = "IssueYear DESC";
        }
        else if (HasIssueDateField)
        {
            gridData.OrderBy = "IssueDate DESC";
        }
        else if (HasStartDateField)
        {
            gridData.OrderBy = "StartDate DESC";
        }
        else if (HasComNameField)
        {
            gridData.OrderBy = "ComName ASC";
        }
        else if (HasDateSubmittedField)
        {
            gridData.OrderBy = "DateSubmitted DESC";
        }

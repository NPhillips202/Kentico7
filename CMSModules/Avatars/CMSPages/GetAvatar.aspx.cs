    ...
    protected void SendFile(CMSOutputAvatar file)
    {
        ...
        if (file != null)
        {
            ...
            if (useClientCache && AllowCache && AllowClientCache && ETagsMatch(etag, file.LastModified))
            {
                ...
                if (file.Avatar != null)
                {
                    Response.ContentType = GetResponseContentType(file.MimeType, file.Avatar.AvatarFileExtension);
                }
            ...
            if ((file.OutputData != null) || (file.PhysicalFile != ""))
            {
                ...
                // Prepare response
                Response.ContentType = Response.ContentType = GetResponseContentType(file.MimeType, extension);

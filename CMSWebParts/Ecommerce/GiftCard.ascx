<%@ Control Language="C#" AutoEventWireup="true" CodeFile="~/CMSWebParts/Ecommerce/GiftCard.ascx.cs" Inherits="CMSWebParts_Ecommerce_Donate" %>
<%@ Register TagPrefix="cms" TagName="DonationProperties" Src="~/CMSModules/Ecommerce/Controls/ProductOptions/GiftCardProperties.ascx" %>

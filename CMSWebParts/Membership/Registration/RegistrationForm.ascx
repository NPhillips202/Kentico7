...
<asp:Panel ID="pnlForm" runat="server" DefaultButton="btnOK">
    <table>
        ...
        <tr>
            ...
            <td>               
                <cms:PasswordStrength runat="server" ID="passStrength" ShowValidationOnNewLine="true" TextBoxClass="LogonTextBox" EnableAutoComplete="false"  />               
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <cms:CMSRequiredFieldValidator ID="rfvConfirmPassword" runat="server" ControlToValidate="txtConfirmPassword"
                    Display="Dynamic" EnableViewState="false" EnableAutoComplete="false"  />
            </td>
        </tr>

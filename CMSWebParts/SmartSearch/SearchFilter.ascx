...
<asp:RadioButtonList runat="server" ID="radlstFilter" Visible="false" CssClass="ContentRadioButtonList"></asp:RadioButtonList>
<asp:CheckBoxList runat="server" ID="chklstFilter" Visible="false" CssClass="ContentCheckBoxList"></asp:CheckBoxList>
